...
void ShiftRows(uint8_t state[][4])
{
	...
	// Shift left by 1
	t = state[1][0];
	state[1][0] = (uint8_t)(state[1][1]);
	state[1][1] = (uint8_t)(state[1][2]);
	state[1][2] = (uint8_t)(state[1][3]);
	state[1][3] = (uint8_t)(t);
	// Shift left by 2
	t = state[2][0];
	state[2][0] = (uint8_t)(state[2][2]);
	state[2][2] = (uint8_t)(t);
	t = state[2][1];
	state[2][1] = (uint8_t)(state[2][3]);
	state[2][3] = (uint8_t)(t);
	// Shift left by 3
	t = state[3][0];
	state[3][0] = (uint8_t)(state[3][3]);
	state[3][3] = (uint8_t)(state[3][2]);
	state[3][2] = (uint8_t)(state[3][1]);
	state[3][1] = (uint8_t)(t);
}
...
void InvShiftRows(uint8_t state[][4])
{
	...
	// Shift right by 1
	t = state[1][3];
	state[1][3] = (uint8_t)(state[1][2]);
	state[1][2] = (uint8_t)(state[1][1]);
	state[1][1] = (uint8_t)(state[1][0]);
	state[1][0] = (uint8_t)(t);
	// Shift right by 2
	t = state[2][3];
	state[2][3] = (uint8_t)(state[2][1]);
	state[2][1] = (uint8_t)(t);
	t = state[2][2];
	state[2][2] = (uint8_t)(state[2][0]);
	state[2][0] = (uint8_t)(t);
	// Shift right by 3
	t = state[3][3];
	state[3][3] = (uint8_t)(state[3][0]);
	state[3][0] = (uint8_t)(state[3][1]);
	state[3][1] = (uint8_t)(state[3][2]);
	state[3][2] = (uint8_t)(t);
}
